...
const instrumentsData: Omit<Instrument, 'color' | 'imageUrl'>[] = [
  ...
  { id: 'nordic-women-choir', name: 'Nordic Voices - Women', collection: 'Women of the North', collectionSlug: 'women-of-the-north', category: 'vocals', moods: ['ethereal', 'peaceful', 'mysterious'], genres: ['world', 'cinematic', 'ambient'], roles: ['texture', 'lead'], isPremium: true, description: 'Nordic female choir', tags: ['choir', 'vocals', 'nordic', 'women'] },

  // ============================================
  // WORLD INSTRUMENTS
  // ============================================
  { id: 'iceland-strings', name: 'Iceland - String Textures', collection: 'World Series: Iceland', collectionSlug: 'world-series-iceland', category: 'world', moods: ['ethereal', 'peaceful', 'mysterious'], genres: ['world', 'ambient', 'cinematic'], roles: ['texture'], isPremium: true, description: 'Icelandic string textures', tags: ['world', 'iceland', 'strings', 'ambient'] },
  { id: 'iceland-vocals', name: 'Iceland - Vocal Textures', collection: 'World Series: Iceland', collectionSlug: 'world-series-iceland', category: 'world', moods: ['ethereal', 'mysterious', 'peaceful'], genres: ['world', 'ambient'], roles: ['texture'], isPremium: true, description: 'Icelandic vocal textures', tags: ['world', 'iceland', 'vocals'] },
  ...
  { id: 'cineharps-glissandos', name: 'CineHarps - Glissandos', collection: 'CineHarps', collectionSlug: 'cineharps', category: 'strings', moods: ['dreamy', 'magical', 'bright'], genres: ['cinematic', 'classical'], roles: ['texture', 'accent'], isPremium: true, description: 'Harp glissando collection', tags: ['harp', 'glissando', 'orchestral'] },
